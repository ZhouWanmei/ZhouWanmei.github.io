    ...
    $.ajax({
        ...
        success:function(menus){
            ...
            menus.forEach(function(obj){
                htmlStr += ` 
                <li>
                    <a href="/douguo/html/menuDetails.html?menusId=${obj.id}" target="_blank"><img class="foodImg" src="../images/menu/foods/food-${obj.id}/${obj.img}" alt="图片加载失败..."></a>
                    <a class="title"  href="/douguo/html/menuDetails.html?menusId=${obj.id}" target="blank">${obj.title}</a>
