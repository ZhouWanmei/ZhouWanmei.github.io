(function(){
    ...
    $.ajax({
        ...
        success:function(list){
            ...
            list.forEach(function(obj,index){
                htmlStr+=`
                <li>
                <a href="javascript:;"><img class="food" src="/douguo/images/diet/${obj.img}" alt="图片加载失败..."></a>
                <div class="mask">
    ...
    $.ajax({
        url:"/douguo/json/recommendRestaurant.json",
                    ...
                    ${(function(){
                        ...
                        obj.specialDishes.forEach(function(listStr,index){
                            specialDishesStr += `
                                <li>
                                    <a href="javascript:;">
                                        <img src="/douguo/images/diet/restaurant/${obj.specialDishes[index].img}">
    ...
    $.ajax({
        url:"/douguo/json/hotRestaurant.json",
        success:function(lists){
            var htmlStr = ``;
            lists.forEach(function(list){
                htmlStr += `
                    <li>
                        <a href="javascript:;"><img src="/douguo/images/diet/hotRestaurant/${list.img}" alt="图片加载失败..."></a>
