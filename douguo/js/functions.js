...
function search(){
    ...
    searchBtn.onclick = function() {
        //跳转到搜索结果展示页
        window.location.href="../html/searchDisplay.html";
    }
}
    ...
    $.ajax({
        ...
        success: function(recommend) {
            ...
            datas.forEach(function(obj, index){
                    htmlStr += `
                        <li class="clearFix">
                            <a href="./goodsDetail.html?goodsId=${obj.id}" target="_blank"><img class="fl" src="../images/mall/goods-${obj.id}/${obj.img}" alt="图片加载失败..."></a>
                            <div class="goods-infos fl">
                                <p class="title">商品名称：<a href="./goodsDetail.html?goodsId=${obj.id}" target="_blank">${obj.describe}</a></p>
        ...
        success: function(recommend) {
            ...
            recommend.forEach(function(obj, index){
                if(obj.video){
                    ...
                    <li>
                        <a href="javascript:;">
                            <img src="../images/index/everydayRecommend/${obj.img}" alt="图片加载失败...">
                            
                        </a>
                        <p class="describe"><a href="javascript:;">${obj.describe}</a></p>
                        <p class="author">${obj.author}</p>
                        <img class="vedioIcon" src="../images/index/everydayRecommend/video_icon.png"><img>
                    </li>`;
                }else{
                    htmlStr += `
                    <li>
        ...
        success: function(recommend) {
            ...
            recommend.forEach(function(obj, index){
                if(index < 4){ 
                    htmlStr += `
                        <li>
                            <a href="./html/goodsDetail.html?goodsId=${obj.id}" target="_blank">
                                <img src="../images/mall/goods-${obj.id}/${obj.img}" alt="图片加载失败...">
                            </a>
                            <p class="describe"><a href="./html/goodsDetail.html?booksId=${obj.id}" target="blank" title="${obj.describe}">${obj.describe}</a></p>
                            <p class="price">
        ...
        success: function(foods) {
            ...
            foods.forEach(function(obj, index){
                htmlStr += `
                    <li>
                        <a href="javascript:;">
                            <img src="../images/index/seasonableFood/${obj.img}" alt="图片加载失败...">
                            ${obj.title}
                        </a>
                    </li>`;   
            });
        ...
        success:function(list){
            ...
            list.forEach(function(obj,index){
                if(index<=5){
                    htmlStr+=`
                    <li>
                        <a href="javascript:;"><img src="../images/diet/${obj.img}" alt="图片加载失败..."></a>
    ...
    $.ajax({
        ...
        success:function(list){
            ...
            list.forEach(function(obj){
                htmlStr+=`
                <li class="clearFix">
                    <img class="fl" src="../images/index/note/${obj.img}" alt="图片加载失败...">
                    ...
                    <section class="exhibition fr">
                        <img src="../images/index/note/${obj.exhibition[0]}" alt="图片加载失败...">
                        <img src="../images/index/note/${obj.exhibition[1]}" alt="图片加载失败...">
                        <img src="../images/index/note/${obj.exhibition[2]}" alt="图片加载失败...">
                    </section>
                </li>`;
            });
    ...
    $.ajax({
        ...
        success:function(menus){
            ...
            menus.forEach(function(obj){
                htmlStr+=`
                <li class="clearFix">
                    <a class="fl" href="javascript:;"><img src="../images/index/superman/${obj.img}" alt="图片加载失败"></a>
                    <div class="write fl">
...
function loadingArticles(parentNode,datas,curIndex,curSpan){
    ...
    for(var i = starIndex; i <= endIndex; i++){
        htmlStr += `
            <li class="clearFix">
                <div class="img-box fl"><img src="../images/article/${datas[i].img}" alt="图片加载失败..."></div>
                <div class="des fl">
