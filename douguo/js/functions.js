    ...
    $.ajax({
        ...
        success: function(recommend) {
            ...
            datas.forEach(function(obj, index){
                    htmlStr += `
                        <li class="clearFix">
                            <a href="/douguo/html/goodsDetail.html?goodsId=${obj.id}" target="_blank"><img class="fl" src="../images/mall/goods-${obj.id}/${obj.img}" alt="图片加载失败..."></a>
            ...
            recommend.forEach(function(obj, index){
                if(obj.video){
                    ...
                    <li>
                        ...
                        <img class="vedioIcon" src="/douguo/images/index/everydayRecommend/video_icon.png"><img>
                    </li>`;
                }else{
                    htmlStr += `
                    <li>
        ...
        success: function(recommend) {
            ...
            recommend.forEach(function(obj, index){
                if(index < 4){ 
                    htmlStr += `
                        <li>
                            <a href="/douguo/html/goodsDetail.html?goodsId=${obj.id}" target="_blank">
                                <img src="/douguo/images/mall/goods-${obj.id}/${obj.img}" alt="图片加载失败...">
                            </a>
                            <p class="describe"><a href="/douguo/html/goodsDetail.html?booksId=${obj.id}" target="blank" title="${obj.describe}">${obj.describe}</a></p>
                            <p class="price">
