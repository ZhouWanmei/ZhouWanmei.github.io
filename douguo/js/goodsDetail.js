                ...
                <section class="tab-wrapper clearFix">
                    ...
                    ${(function(){
                        ...
                        goods.detail.forEach(function(img,index){
                            if(index === 0){
                                menuStr += `<li class="selected"><img src="../images/mall/goods-${goods.id}/${goods.detail[index]}" alt=""></li>`;
                            }else{
                                menuStr += `<li><img src="../images/mall/goods-${goods.id}/${goods.detail[index]}" alt=""></li>`;  
                            }
                        });
                        return menuStr;
                    })()}
                    ...
                    ${(function(){
                        ...
                        goods.detailEnlarge.forEach(function(smallImg,index){
                            if(index === 0){
                                menuStr += `<img class="small-img show" src="../images/mall/goods-${goods.id}/${goods.detailEnlarge[index]}" alt="图片加载失败...">`;
                            }else{
                                menuStr += `<img class="small-img" src="../images/mall/goods-${goods.id}/${goods.detailEnlarge[index]}" alt="图片加载失败...">`;  
                            }
                        });
                        return menuStr;
                    })()}
                    ...
                    ${(function(){
                        ...
                        goods.detailEnlarge.forEach(function(bigImg,index){
                            ...
                            if(index === 0){
                                imgStr += `<img class="big-img show" src="../images/mall/goods-${goods.id}/${goods.detailEnlarge[index]}" alt="">`;
                            }else{
                                imgStr += `<img class="big-img" src="../images/mall/goods-${goods.id}/${goods.detailEnlarge[index]}" alt="">`;
                            }
                        });
                        return imgStr;
                    })()}
